							...
							<div class="description">
								...
								<div class="row">
									<div class="col-xl-6">
										...
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Court</label>
											<div class="col-lg-9">
												<input type="text" class="form-control" name="city" required placeholder="Enter Court">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Estate</label>
											<div class="col-lg-9">
												<input type="text" class="form-control" name="state" required placeholder="Enter Estate">
											</div>
										</div>
									</div> 
									<div class="col-xl-6">
