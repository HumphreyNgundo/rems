...
<div class="header">
	...
	<div class="header-left">
		<a href="dashboard.php" class="logo">
			<img src="assets/img/hslogo2.png" alt="Logo">
		</a>
		<a href="dashboard.php" class="logo logo-small">
			<img src="assets/img/hslogo2_copy.png" alt="Logo" width="30" height="30">
		</a>
	</div>
	<!-- /Logo -->
	...
	<div class="sidebar-inner slimscroll">
		<div id="sidebar-menu" class="sidebar-menu">
			<ul>
				...
				<li class="menu-title">
					<span>Estate & Court</span>
				</li>

				<li class="submenu">
					<a href="#"><i class="fe fe-location"></i> <span>Estate & Court</span> <span class="menu-arrow"></span></a>
					<ul style="display: none;">
						<li><a href="stateadd.php"> Estate </a></li>
						<li><a href="cityadd.php"> Court </a></li>
					</ul>
				</li>
