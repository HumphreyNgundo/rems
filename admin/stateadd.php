...
if (isset($_POST['insert'])) {
	...
	if (!empty($state)) {
		...
		if ($result) {
			$msg = "<p class='alert alert-success'>Estate Inserted Successfully</p>";
		} else {
			$error = "<p class='alert alert-warning'>* Estate Not Inserted</p>";
		}
	} else {
		...
		<div class="content container-fluid">
				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header">
							<h1 class="card-title">Add Estate</h1>
							<?php echo $error; ?>
							<?php echo $msg; ?>
							<?php
							if (isset($_GET['msg']))
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title">Estate List</h4>
