...
if (isset($_POST['insert'])) {
	...
	if (!empty($state) && !empty($city)) {
		...
		if ($result) {
			$msg = "<p class='alert alert-success'>Court Inserted Successfully</p>";
		} else {
			$error = "<p class='alert alert-warning'>* Court Not Inserted</p>";
		}
	} else {
				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header">
							<h1 class="card-title">Add Court</h1>
							<?php echo $error; ?>
							<?php echo $msg; ?>
							<?php
							if (isset($_GET['msg']))
								...
								<div class="row">
									<div class="col-xl-6">
										...
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Estate Name</label>
											<div class="col-lg-9">
										...
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Court Name</label>
											<div class="col-lg-9">
